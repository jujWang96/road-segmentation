...
def layers(loaded_layers, num_classes):
    ...
    '''Decoder'''
    deconv_1 = tf.layers.conv2d_transpose(encoded_7, num_classes, 2, 1, "same", kernel_initializer=tf.truncated_normal_initializer(stddev=0.01)) # padding?
    skip_1 = tf.add(deconv_1, encoded_6)

    deconv_2 = tf.layers.conv2d_transpose(skip_1, num_classes, 2, 1, "same", kernel_initializer=tf.truncated_normal_initializer(stddev=0.01))
    skip_2 = tf.add(deconv_2, encoded_5)

    deconv_3 = tf.layers.conv2d_transpose(skip_2, num_classes, 2, 2, "same", kernel_initializer=tf.truncated_normal_initializer(stddev=0.01))
    skip_3 = tf.add(deconv_3, encoded_4)

    deconv_4 = tf.layers.conv2d_transpose(skip_3, num_classes, 2, 2, "same", kernel_initializer=tf.truncated_normal_initializer(stddev=0.01))
    skip_4 = tf.add(deconv_4, encoded_3)

    deconv_5 = tf.layers.conv2d_transpose(skip_4, num_classes, 2, 2, "same", kernel_initializer=tf.truncated_normal_initializer(stddev=0.01))
    skip_5 = tf.add(deconv_5, encoded_2)

    deconv_6 = tf.layers.conv2d_transpose(skip_5, num_classes, 2, 2, "same", kernel_initializer=tf.truncated_normal_initializer(stddev=0.01))
    skip_6 = tf.add(deconv_6, encoded_1)

    deconv_7 = tf.layers.conv2d_transpose(skip_6, num_classes, 4, 2, "same", kernel_initializer=tf.truncated_normal_initializer(stddev=0.01))
